...
(define-abbrev-table 'elixir-mix-compilation-mode-abbrev-table '())
...
(define-abbrev-table 'gnus-kill-file-mode-abbrev-table '())
...
(define-abbrev-table 'js2-mode-abbrev-table
  '(
    ("@" "this" nil 2)
    ("cdl" "" javascript-cdl 8)
    ("dsnum" "DS.attr('number')" nil 0)
    ("dsstr" "DS.attr('string')" nil 0)
   ))
...
(define-abbrev-table 'org-mode-abbrev-table
  '(
    ("9nohnum" "#+OPTIONS: num:nil" nil 0)
    ("9notoc" "#+OPTIONS: toc:nil" nil 0)
   ))
